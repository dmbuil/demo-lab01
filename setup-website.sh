...
find /var/www/html/*.php -type f -print0 | xargs -0 sed -i '.bak' "s/{lab.db.ip}/$LAB_DATABASE_IP/g"
find /var/www/html/*.php -type f -print0 | xargs -0 sed -i '.bak' "s/{lab.db.fqdn}/$LAB_DATABASE_FQDN/g"
find /var/www/html/*.php -type f -print0 | xargs -0 sed -i '.bak' "s/{lab.db.password}/$LAB_DATABASE_PASSWD/g"
find /var/www/html/*.php -type f -print0 | xargs -0 sed -i '.bak' "s/{lab.db.name}/$LAB_DATABASE_NAME/g"
find /var/www/html/*.php -type f -print0 | xargs -0 sed -i '.bak' "s/{lab.db.user}/$LAB_DATABASE_USER/g"
